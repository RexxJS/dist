...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory((function webpackLoadOptionalExternalModule() { try { return require("node-fetch"); } catch(e) {} }()));
	else if(typeof define === 'function' && define.amd)
		define(["node-fetch"], factory);
	else if(typeof exports === 'object')
		exports["openai-address"] = factory((function webpackLoadOptionalExternalModule() { try { return require("node-fetch"); } catch(e) {} }()));
	else
		root["openai-address"] = factory(root["node-fetch"]);
})(this, (__WEBPACK_EXTERNAL_MODULE_node_fetch__) => {
...
"use strict";
if(typeof __WEBPACK_EXTERNAL_MODULE_node_fetch__ === 'undefined') { var e = new Error("Cannot find module 'node-fetch'"); e.code = 'MODULE_NOT_FOUND'; throw e; }
